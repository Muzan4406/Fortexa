  ...
  return (
    <UserLayout>
      ...
      <div className="px-4 pb-6 space-y-4">
        ...
        <div className="gradient-green rounded-2xl p-4 relative overflow-hidden">
          {/* Subtle grid overlay */}
        ...
        {/* ── Gains en direct ── */}
        <div className="bg-gradient-to-br from-violet-600 to-purple-800 rounded-2xl p-4 relative overflow-hidden">
          ...
          <div className="relative">
            ...
            <p className="text-white/70 text-xs mt-0.5 mb-3">Solde retirable à tout moment</p>

            <div className="flex items-center justify-between">
              <button
                onClick={() => setLocation('/withdraw')}
                className="bg-white text-purple-700 font-semibold text-sm px-4 py-1.5 rounded-xl hover:bg-white/90 transition-colors"
